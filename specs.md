...
1716810808593627;1716810808574000;68480.00000000;10.10900000;bid;11716810808593627;1716810808574000;68479.90000000;0.00400000;bid;0
...
этого момента**Важно:** В выходной файл записывается строка **только при изменении значения
медианы**.
---
...
- Обработка файлов с некорректным форматом данных- Обработка отсутствующих колонок в CSV
#### Логирование:
...
└── examples/
├── input/
│ ├── btcusdt_level_2024.csv│ └── btcusdt_trade_2024.csv
└── output/
└── median_result.csv
```
### 5.2. Пример запуска
...
- Результаты сохраняются в `./output`### Пример 4: Обработка данных с несколькими временными метками
...
- Измеримое ускорение на больших объемах данных### 7.2. Различные типы агрегации
...
**Мы оцениваем:**
- Умение задавать вопросы- Способность работать с неполной информацией
